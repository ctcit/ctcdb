...
function EmitRow($archiveItem){
    ...
    $row = '<tr class = "archiveitem" style="display: none; ">';
    $row .= '<td class = "col0"><input type = "checkbox" id='.$id.' title = "Click to select this item" data-caption="'.$caption.'" style = "cursor:pointer;"></input></td>';
    if ($caneditthis)
