...
<?php
  $posturl = config_item("base_url")."/index.php/open/forgottenPasswordSubmit";
  echo '<form action="'.$posturl.'" method="post">';
?>
<p>Please enter your login name.</p>

<p>If  you can't remember that then you can enter the email address or phone number associated with your user account.</p>
